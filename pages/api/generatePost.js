...
export default withApiAuthRequired(async function handler(req, res) {
	...
	const db = client.db("BlogBuilder");
	...
	// const topic = "What is Dark matter";
	// const keywords = "matter, universe, particle";

	// const result = await openai.createCompletion({
	// 	model: "text-davinci-003",
	// 	temperature: 0,
	// 	max_tokens: 3600,
	// 	prompt: `write a blog post on dark matter`,
	// });

	// console.log("Result: ", result.choice[0].text);
